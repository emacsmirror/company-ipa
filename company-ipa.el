...
(defcustom company-ipa-symbol-list-basic
  '(("vowel" "a" "[vowel]" "open back unrounded" 593 "ɑ")
    ...
    ("diac" "_" "[sub]" "voiceless" 805 "n̥")
    ("diac" "^" "[sup]" "voiceless" 778 "ŋ̊")
    ("diac" "_" "[sub]" "breathy voiced" 804 "b̤")
    ("diac" "_" "[sub]" "dental" 810 "t̪")
    ("diac" "_" "[sub]" "voiced" 812 "s̬")
    ("diac" "_" "[sub]" "creaky voiced" 816 "b̰")
    ("diac" "_" "[sub]" "apical" 826 "t̺")
    ("diac" "_" "[sub]" "linguolabial" 828 "t̼")
    ("diac" "_" "[sub]" "laminal" 827 "t̻")
    ("diac" "_" "[sub]" "not audibly released" 794 "t̚")
    ("diac" "_" "[sub]" "more rounded" 825 "ɔ̹")
    ("diac" "^" "[sup]" "nasalized" 771 "ẽ")
    ("diac" "_" "[sub]" "less rounded" 796 "ɔ̜")
    ("diac" "_" "[sub]" "advanced" 799 "u̟")
    ("diac" "_" "[sub]" "retracted" 800 "e̠")

    ("diac" "^" "[sup]" "centralized" 776 "ë")
    ("diac" "_" "[sub]" "velarized or pharyngealized" 820 "l̴")
    ("diac" "^" "[sup]" "mid-centralized" 829 "e̽")
    ("diac" "_" "[sub]" "raised" 797 "e̝")
    ("diac" "_" "[sub]" "syllabic" 809 "m̩")
    ("diac" "_" "[sub]" "lowered" 798 "e̞")
    ("diac" "_" "[sub]" "non-syllabic" 815 "e̯")
    ("diac" "_" "[sub]" "advanced tongue root" 792 "e̘")
...
Argument ALIST an alist of IPA symboles."
  (delq nil
        (mapcar
         (lambda (el)
           (let* ((tex (concat company-ipa-symbol-prefix (company-ipa--make-description (nth 1 el) (nth 2 el) (nth 3 el))))
                  (ch (and (nth 4 el) (decode-char 'ucs (nth 4 el))))
...
the elements 1, 2 and 3 (counting from zero) in
